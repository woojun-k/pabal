...
import com.polarishb.pabal.user.infrastructure.persistence.UserRepositoryImpl;
...
public abstract class AbstractUserPostgresDataJpaTest {
    ...
    static void registerProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("spring.flyway.locations", AbstractUserPostgresDataJpaTest::flywayMigrationLocation);
    }
    ...
    private static PostgreSQLContainer<?> startPostgres() {
        ...
        Runtime.getRuntime().addShutdownHook(new Thread(
                container::close,
                "pabal-user-postgres-testcontainer-shutdown"
        ));
        return container;
    }

    @SpringBootConfiguration
    @EntityScan(basePackageClasses = TenantUserEntity.class)
    @EnableJpaRepositories(basePackageClasses = TenantUserJpaRepository.class)
