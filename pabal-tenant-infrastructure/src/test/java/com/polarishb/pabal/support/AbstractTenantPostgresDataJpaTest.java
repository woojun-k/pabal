...
@ContextConfiguration(classes = AbstractTenantPostgresDataJpaTest.PersistenceTestApplication.class)
public abstract class AbstractTenantPostgresDataJpaTest {
    ...
    static void registerProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("spring.flyway.locations", AbstractTenantPostgresDataJpaTest::flywayMigrationLocation);
    }
    ...
    private static PostgreSQLContainer startPostgres() {
        ...
        Runtime.getRuntime().addShutdownHook(new Thread(
                container::close,
                "pabal-tenant-postgres-testcontainer-shutdown"
        ));
        return container;
    }
