...
import com.polarishb.pabal.messenger.infrastructure.realtime.ws.ChatRealtimeDestinations;
...
public class StompMessageAuthorizationConfig {
    ...
    AuthorizationManager<Message<?>> messageAuthorizationManager() {
        ...
        messages
                ...
                .simpSubscribeDestMatchers(ChatRealtimeDestinations.userControlSubscription()).authenticated()
